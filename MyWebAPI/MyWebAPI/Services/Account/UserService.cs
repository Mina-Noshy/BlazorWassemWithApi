...
namespace MyWebAPI.Services.Account
{
    ...
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager, IOptions<JWT> jwt, AppDbContext context)
        {
            _context = context;
        ...
        private async Task<JwtSecurityToken> CreateJwtToken(AppUser user)
        {
            ...
            var jwtSecurityToken = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.UtcNow.AddMinutes(_jwt.Expire),
