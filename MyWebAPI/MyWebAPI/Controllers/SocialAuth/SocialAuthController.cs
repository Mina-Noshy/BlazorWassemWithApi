...
namespace MyWebAPI.Controllers.SocialAuth
{
    ...
    public class SocialAuthController : ControllerBase
    {
        ...
        //        appUser.UserName = CreateUniqueUserName($"{appUser.FirstName} {appUser.LastName}");
        ...
        //    var expires = issuedAt.AddMinutes(Convert.ToDouble(_configuration["JWT:Expire"]));
        //    var expirySeconds = (long)TimeSpan.FromSeconds(Convert.ToDouble(_configuration["JWT:Expire"])).TotalSeconds;
